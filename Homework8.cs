...
class Program
{
    ...
    }//q1 - Calc the sum of elements in a given int_array
    ...
    }//q2.1 given a 2d array, print all the off elements
    ...
    public static int[,] DoubleArray(int[,] array_2d){
        int[,] doubleArray = new int [array_2d.GetLength(0), array_2d.GetLength(1)];
        for (int i=0; i<array_2d.GetLength(0); i++){
            for (int j=0; j<array_2d.GetLength(1); j++){
